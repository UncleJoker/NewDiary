...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        DWSettingSwitchTableViewCell *cell = [[DWSettingSwitchTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"SettingBGCell" title:@"开启跟随系统主题颜色"];
        cell.switcher.tag = 1;
        cell.delegate = self;
        return cell;
    }
